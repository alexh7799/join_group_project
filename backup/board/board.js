const BASE_URL_TASKS = "https://join-c39f7-default-rtdb.europe-west1.firebasedatabase.app/tasks";
let tasks = [];

const BASE_URL_ASSIGNED = "https://join-c39f7-default-rtdb.europe-west1.firebasedatabase.app/tasks";
let bigassigned = [];
...
function updateHtmlTodo() {
  let todo = tasks.filter((x) => x["category"] == "toDos");
...
function updateHtmlAwait() {
  let await = tasks.filter((x) => x["category"] == "awaiting");
