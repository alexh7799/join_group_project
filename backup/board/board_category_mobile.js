const categories = ["toDos", "progress", "awaiting", "done"];
...
function renderArrows(category, taskId) {
  ...
  if (category === "done") {
    arrowUpHtml = `<img class="arrow_up" src="../assets/icons/arrow-up-dropdown.svg" onclick="moveTaskUp('${taskId}', event)">`;
  } else if (category === "todo") {
    arrowDownHtml = `<img class="arrow_down" src="../assets/icons/arrow-dropdown.svg" onclick="moveTaskDown('${taskId}', event)">`;
  } else {
    arrowUpHtml = `<img class="arrow_up" src="../assets/icons/arrow-up-dropdown.svg" onclick="moveTaskUp('${taskId}', event)">`;
    arrowDownHtml = `<img class="arrow_down" src="../assets/icons/arrow-dropdown.svg" onclick="moveTaskDown('${taskId}', event)">`;
  }
