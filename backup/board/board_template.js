...
function renderTaskCardToDo(elementToDo) {
  const subtasks = elementToDo.subtasks || {};
  const subAmountHtml = generateSubAmountHtml(subtasks);
  const truncatedDescription = truncateText(elementToDo["descr"], 35);
...
function renderTaskCardProgress(elementProgress) {
  const subtasks = elementProgress.subtasks || {};
  const subAmountHtml = generateSubAmountHtml(subtasks);
  const truncatedDescription = truncateText(elementProgress["descr"], 35);
...
function renderTaskCardAwait(elementAwait) {
  const subtasks = elementAwait.subtasks || {};
  const subAmountHtml = generateSubAmountHtml(subtasks);
  const truncatedDescription = truncateText(elementAwait["descr"], 35);
...
function renderTaskCardDone(elementDone) {
  const subtasks = elementDone.subtasks || {};
  const subAmountHtml = generateSubAmountHtml(subtasks);
  const truncatedDescription = truncateText(elementDone["descr"], 35);
