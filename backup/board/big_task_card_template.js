...
function renderBigTaskCard(bigelement) {
  console.log(bigelement)
    return `
      ...
      <div class="big_description" id="big_description_${bigelement["descr"]}">${bigelement["descr"]}</div>
        
      <div class="big_due" id="big_due">
        <div class="big_due_date_txt" id="big_due_date_txt">Due date:</div>
        <div class="big_due_date" id="big_due_date">${bigelement["date"]}</div>
      </div>
      ...
      <div class="big_assigned">
        ...
        <div class="assigned_div">${renderBigAssignedContacts(bigelement.user)}</div>
      </div>
  
      <div class="big_subs">
        <div class="big_subs_txt">Subtasks</div>
        <div class="subtasks_container">${renderSubtasks(bigelement.subtasks, bigelement.id)}</div>
      </div>
